...
@section('content')
    <div class="container">
        <div id="content">
            ...
            <form action="#" method="post" class="beta-form-checkout" onsubmit={{ route('banhang.getdathang') }}>
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                        <h4>Đặt hàng</h4>
                    ...
                    <div class="col-sm-6">
                        <div class="your-order">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span class="color-gray your-order-info">Thành tiền:
                                                            {{ number_format($thanhtien) }} đồng</span>
                                                    </div>
                                                </div>
                                                <!-- end one item -->
                                            @endforeach
                            ...
                            @endif
                            <div class="text-center"><input type="submit" class="beta-btn primary" value="Đặt hàng"><i
